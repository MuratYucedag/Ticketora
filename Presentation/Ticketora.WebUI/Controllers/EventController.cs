...
namespace Ticketora.WebUI.Controllers
{
    public class EventController : Controller
    {
        ...
        public EventController(GetEventQueryHandler getEventQueryHandler, GetByIdEventQueryHandler getByIdEventQueryHandler, CreateEventCommandHandler createEventCommandHandler, UpdateEventCommandHandler updateEventCommandHandler, RemoveEventCommandHandler removeEventCommandHandler)
        {
...
/*
 ...
 --------------------------
 Mikroservis
 Büyük Veri Analiğiti & Tahminleme
 SignalR
 Identity - Portfolio
 Docker
 Maui**
